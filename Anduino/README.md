...
For more details on how to hook up the bluettoth board to the Arduino check [here](https://learn.adafruit.com/getting-started-with-the-nrf8001-bluefruit-le-breakout/hooking-everything-up) for more details
